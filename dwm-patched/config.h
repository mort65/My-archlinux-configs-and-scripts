...
static const char col_blue3[]       = "#00a1c9";
...
static const Rule rules[] = {
	 ...
	 */
	/*Match condition Tags Center Float Permanent BorderColor Terminal NoSwallow NoBorder Monitor*/
	...
	{ CLASS("Firefox|Chromium|Google-chrome|Vivaldi-stable"),   TAG(2),  0,   0,   0,   0,  0,  1,  0,   0 },
        { CLASS("Thunar|Pcmanfm|pcmanfm-qt"),   TAG(3),   0,   0,   0,   0,   0,   1,   0,   0 },
	{ CLASS("Pragha"),  TAG(5),   0,   0,   0,   0,   0,   1,   0,   0 },
        { CLASS("Geany|Leafpad"),   TAG(6),   0,   0,   0,   0,   0,   1,   0,   0 },
	{ CLASS("Steam"),  TAG(7),   0,   0,   0,   0,   0,   1,   0,   0 },
        { CLASS("VirtualBox"),   TAG(8),   0,   0,   0,   0,   0,   1,   0,   0 },
        { CLASS("Tixati"),   TAG(9),   0,   0,   0,   0,   0,   1,   0,   0 },

        /*Floating windows*/
        { CLASS("St"),   0,   1,   1,   0,   0,   1,   1,   0,   0 },
        { CLASS("KeePass2"),   0,   0,   1,   0,   0,   0,   0,   0,   0 },
        { CLASS_INSTANCE("ScratchPad","ScratchPad(1|2)"),  0,   1,   1,   1,   0,   1,   1,   0,   0 },
	{ CLASS("Wine|Zenity"),   TAG(7),   1,   1,   0,   0,   0,   1,   0,   0 },
	{ CLASS("Lutris"),   TAG(8),   1,   0,   0,   0,   0,   1,   0,   0 },
	{ CLASS_INSTANCE_TITLE("Wine","darksoulsiii.exe","DARK SOULS III"),   TAG(7),   1,   0,   0,   1,   0,   1,   1,   0 },
	{ CLASS_INSTANCE("Wine","darksoulsiii.exe"),   TAG(7),   1,   0,   0,   1,   0,   1,   1,   0 },
	{ CLASS_TITLE("Wine","DARK SOULS III"),   TAG(7),   1,   0,   0,   1,   0,   1,   1,   0 },
        { CLASS("Mlconfig"),  0,   1,   1,   0,   0,   0,   1,   0,   0 },
	{ CLASS("Nitrogen|Dukto|Galculator|lxsu|lxsudo|Gpick"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("File Operation Progress"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("Module"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("Search Dialog"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("Goto"),  0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("IDLE Preferences"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("Preferences"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("File Transfer"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("branchdialog"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
        { TITLE("pinentry"),   0,   0,   1,   0,   0,   0,   1,   0,   0 },
