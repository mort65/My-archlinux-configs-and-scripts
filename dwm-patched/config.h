...
static const Rule rules[] = {
	...
	{ CLASS("vlc|smplayer|mpv|smplayer"),   TAG(1)|TAG(3)|TAG(4),   0,   0,   0,   0,   0,  1,  0 },
	{ CLASS("Firefox|Chromium|Google-chrome|Vivaldi-stable"),   TAG(2),  0,   0,   0,   0,  0,  1,  0 },
        { CLASS("Thunar|Pcmanfm|pcmanfm-qt"),   TAG(3),   0,   0,   0,   0,   0,   1,   0 },
	{ CLASS("Pragha"),  TAG(5),   0,   0,   0,   0,   0,   1,   0 },
        { CLASS("Geany|Leafpad"),   TAG(6),   0,   0,   0,   0,   0,   1,   0 },
	{ CLASS("Steam"),  TAG(7),   0,   0,   0,   0,   0,   1,   0 },
        { CLASS("VirtualBox"),   TAG(8),   0,   0,   0,   0,   0,   1,   0 },
	...
	{ CLASS("Lutris"),   TAG(7),   1,   0,   0,   0,   0,   1,   0 },
	...
	{ CLASS("Nitrogen|Dukto|Galculator|lxsu|lxsudo|Gpick"),   0,   0,   1,   0,   0,   0,   1,   0 },
        ...
        { TITLE("Module"),   0,   0,   1,   0,   0,   0,   1,   0 },
        { TITLE("Search Dialog"),   0,   0,   1,   0,   0,   0,   1,   0 },
        { TITLE("Goto"),  0,   0,   1,   0,   0,   0,   1,   0 },
        { TITLE("IDLE Preferences"),   0,   0,   1,   0,   0,   0,   1,   0 },
        { TITLE("Preferences"),   0,   0,   1,   0,   0,   0,   1,   0 },
        { TITLE("File Transfer"),   0,   0,   1,   0,   0,   0,   1,   0 },
        { TITLE("branchdialog"),   0,   0,   1,   0,   0,   0,   1,   0 },
        { TITLE("pinentry"),   0,   0,   1,   0,   0,   0,   1,   0 },
